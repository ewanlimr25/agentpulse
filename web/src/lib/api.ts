...
export const runsApi = {
  ...
  promptDiff: (projectId: string, runIdA: string, runIdB: string): Promise<RunPromptDiff> =>
    apiFetch<RunPromptDiff>(
      `/api/v1/projects/${projectId}/runs/compare/prompt-diff?a=${runIdA}&b=${runIdB}`
    ),
